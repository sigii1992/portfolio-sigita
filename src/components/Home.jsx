...
const Home = () => {
  return (
    <div
      name="home"
      className="w-full min-h-screen bg-gradient-to-r from-rose-100 to-teal-100 font-[Kanit]"
    >
      {/*Container */}
      <div className="max-w-[1000px] mx-auto py-20 px-4 sm:px-12 flex flex-col justify-center min-h-screen">
        ...
        <h1 className="text-[#BC8F8F] text-4xl sm:text-6xl font-bold">
          Sigita Zebrauskaite
        </h1>
        <h2 className="text-[#d18282] text-4xl sm:text-6xl font-bold">
          A passionate Junior Full Stack Developer from Lithuania 🇱🇹 living in
          the UK 🇬🇧
        </h2>
        <p className="text-[#BC8F8F] py-6 max-w-[1000px]">
        ...
        <div>
          <Link to="projects" smooth={true} duration={500} offset={-80}>
            <button className="group text-white border-2 bg-red-500 rounded-full px-6 py-2 flex items-center hover:bg-red-700 hover:scale-110 duration-300">
              View Work
