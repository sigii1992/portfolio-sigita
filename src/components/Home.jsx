  ...
  return (
    ...
    {/*Container */}
        <div className="max-w-[1000px] mx-auto px-12 flex flex-col justify-center h-full">
          ...
          <div>
              <button className='text-white border-2 bg-red-500 rounded-full px-6 py-2 flex items-center hover:bg-red-700'>View Work <BsArrowRightCircleFill className='ml-2'/></button>
          </div>
        </div>
    </div>
  )
