    ...
    <div name='skills' className="w-full h-screen bg-gradient-to-r from-rose-100 to-teal-100 font-[Kanit] text-[#d18282]">
        <div className="max-w-[1000px] mx-auto flex flex-col justify-center w-full h-full p-12">
            ...
            <div className="w-full py-8 text-center grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div onClick={() => window.open('https://developer.mozilla.org/en-US/docs/Web/CSS', "_blank")} className='shadow-md hover:scale-110 duration-300'>
                  <p className="text-red-500 font-semibold pb-2">CSS</p>
                  <img className="w-20 mx-auto mb-2" src={CSS} alt="css"></img>
                </div>
                <div onClick={() => window.open('https://www.ruby-lang.org/en/', "_blank")} className='shadow-md hover:scale-110 duration-300'>
                  <p className="text-red-500 font-semibold pb-2">Ruby</p>
                  <img className="w-20 mx-auto mb-2" src={Ruby} alt="ruby"></img>
                </div>
                <div onClick={() => window.open('https://www.javascript.com/', "_blank")} className='shadow-md hover:scale-110 duration-300'>
                  <p className="text-red-500 font-semibold pb-2">JavaScript</p>
                  <img className="w-20 mx-auto mb-2" src={JS} alt="javascript"></img>
                </div>
                <div onClick={() => window.open('https://reactjs.org/', "_blank")} className='shadow-md hover:scale-110 duration-300'>
                  <p className="text-red-500 font-semibold pb-2">ReactJs</p>
                  <img className="w-20 mx-auto mb-2" src={ReactJs} alt="react"></img>
                </div>
                <div onClick={() => window.open('https://mui.com/', "_blank")} className='shadow-md hover:scale-110 duration-300'>
                ...
                <div onClick={() => window.open('https://getbootstrap.com/', "_blank")} className='shadow-md hover:scale-110 duration-300'>
                ...
                <div onClick={() => window.open('https://www.postgresql.org/', "_blank")} className='shadow-md hover:scale-110 duration-300'>
                ...
                <div onClick={() => window.open('https://www.sqlite.org/index.html', "_blank")} className='shadow-md hover:scale-110 duration-300'>
                ...
                <div onClick={() => window.open('https://git-scm.com/', "_blank")} className='shadow-md hover:scale-110 duration-300'>
                  <p className="text-red-500 font-semibold pb-2">Git</p>
                  <img className="w-20 mx-auto mb-2" src={Git} alt="git"></img>
                </div>
                <div onClick={() => window.open('https://code.visualstudio.com/', "_blank")} className='shadow-md hover:scale-110 duration-300'>
                ...
                <div onClick={() => window.open('https://github.com/', "_blank")} className='shadow-md hover:scale-110 duration-300'>
            ...
            <div>
              <p className="py-4">To know more about my technical and soft skills please visit my <a className="underline underline-offset" href="https://github.com/sigii1992" target='_blank' rel="noreferrer">Github profile</a>.</p>
            </div>  
        </div>
    </div>
  );
